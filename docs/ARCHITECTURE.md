...
**Concept docs:** [`layers/controlplane/README.md`](../layers/controlplane/README.md), [`docs/state-and-reconciliation.md`](state-and-reconciliation.md)
...
**Concept doc:** [`docs/zones-and-regions.md`](zones-and-regions.md)
...
The repo is organized by architectural layer. Each layer is a self-contained folder with its own code, documentation (README.md), and CLI commands. See [`docs/repository.md`](repository.md) for the full conventions.
...
**See also:** [`docs/state-and-reconciliation.md`](state-and-reconciliation.md) for detailed phase models and reconciliation loop design.
