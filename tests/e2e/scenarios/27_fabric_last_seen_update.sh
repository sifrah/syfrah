...
start_node "e2e-seen-1" "${E2E_IP_PREFIX}.10"
start_node "e2e-seen-2" "${E2E_IP_PREFIX}.11"

init_mesh "e2e-seen-1" "${E2E_IP_PREFIX}.10" "node-1"
start_peering "e2e-seen-1"
join_mesh "e2e-seen-2" "${E2E_IP_PREFIX}.10" "${E2E_IP_PREFIX}.11" "node-2"
